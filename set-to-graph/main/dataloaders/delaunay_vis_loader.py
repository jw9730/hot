...
def generate_Delaunay_dataset_different_sizes(node_num):
...
class DelaunayManySizes(Dataset):
    def __init__(self, node_num):
        self.Points, self.Edges = generate_Delaunay_dataset_different_sizes(node_num)
...
def get_delaunay_loader_many_sizes(config, train, node_num):
    batch_size = config.bs
    Delaunay_data = DelaunayManySizes(node_num)
